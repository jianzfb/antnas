# -*- coding: UTF-8 -*-
# @Time    : 2020-05-17 22:50
# @File    : pascal2012_seg_train_and_search.py
...
def argument_parser():
    ...
    parser.add_argument('-draw_env', default='PK-PSeg', type=str, help='Visdom drawing environment')
