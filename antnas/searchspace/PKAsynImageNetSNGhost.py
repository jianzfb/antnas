    ...
    def __init__(self, channles, out_channels, reduction=False):
        ...
        self.params = {
            ...
            'IRB_k3e3_nohs_nose': {'in_chan': channles,
                                   ...
                                   'hs': False,
                                   'se': False},
            'GB_e3_nose': {'in_chan': channles,
                           'expansion': 3,
                           'out_chan': out_channels},
            'GB_e3_se': {'in_chan': channles,
                           'expansion': 3,
                           'out_chan': out_channels,
                            'se_ratio': 1.0},
            'in_chan': channles,
...
class PKAsynImageNetSNGhost(UniformSamplingSuperNetwork):
    def __init__(self,
                 blocks_per_stage,
                 cells_per_block,
                 channels_per_block,
                 data_prop,
                 *args, **kwargs):
        super(PKAsynImageNetSNGhost, self).__init__(*args, **kwargs)
