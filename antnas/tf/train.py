...
from antnas.tf.model import deeplabv3plus
from antnas.tf.config import config_param
from antnas.tf import data_generator

parser = argparse.ArgumentParser(description='test antnas on voc')
